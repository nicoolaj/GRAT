...
help:
	@echo "Tablatures — available targets:"
	@echo "  run       cargo run (opens the app window)"
	@echo "  build     cargo build --release, copy the binary into dist/"
	@echo "  app       bundle dist/Tablatures.app (Info.plist + binary) — macOS only"
...
build:
	cargo build --release
	mkdir -p dist
	cp target/release/tablatures dist/
...
app: build
	@echo "Bundling dist/Tablatures.app..."
	rm -rf dist/Tablatures.app
	mkdir -p dist/Tablatures.app/Contents/MacOS
	cp dist/tablatures dist/Tablatures.app/Contents/MacOS/tablatures
	printf '<?xml version="1.0" encoding="UTF-8"?>\n<!DOCTYPE plist PUBLIC "-//Apple//DTD PLIST 1.0//EN" "http://www.apple.com/DTDs/PropertyList-1.0.dtd">\n<plist version="1.0">\n<dict>\n<key>CFBundleName</key>\n<string>Tablatures</string>\n<key>CFBundleDisplayName</key>\n<string>Tablatures</string>\n<key>CFBundleIdentifier</key>\n<string>com.tablatures.app</string>\n<key>CFBundleExecutable</key>\n<string>tablatures</string>\n<key>CFBundlePackageType</key>\n<string>APPL</string>\n<key>CFBundleShortVersionString</key>\n<string>0.1.0</string>\n<key>CFBundleVersion</key>\n<string>1</string>\n<key>NSHighResolutionCapable</key>\n<true/>\n<key>CFBundleDocumentTypes</key>\n<array>\n<dict>\n<key>CFBundleTypeName</key>\n<string>Tablature Document</string>\n<key>CFBundleTypeExtensions</key>\n<array><string>gtab</string></array>\n<key>CFBundleTypeRole</key>\n<string>Editor</string>\n<key>LSHandlerRank</key>\n<string>Owner</string>\n</dict>\n</array>\n</dict>\n</plist>\n' > dist/Tablatures.app/Contents/Info.plist
	@echo "Bundle ready: dist/Tablatures.app"
